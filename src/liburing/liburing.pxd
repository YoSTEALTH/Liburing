...
cdef extern from 'liburing.h' nogil:
    ...
    int io_uring_submit_and_wait_c 'io_uring_submit_and_wait'(io_uring_t * ring,
                                                              unsigned int wait_nr)
    int io_uring_submit_and_wait_timeout_c 'io_uring_submit_and_wait_timeout'(io_uring_t * ring,
                                                                              io_uring_cqe_t ** cqe_ptr,
                                                                              unsigned int wait_nr,
                                                                              __kernel_timespec * ts,
                                                                              sigset_t * sigmask)
    ...
    void io_uring_cq_advance_c 'io_uring_cq_advance'(io_uring_t * ring, unsigned int nr)
    void io_uring_cqe_seen_c 'io_uring_cqe_seen'(io_uring_t * ring, io_uring_cqe_t * cqe)

    # Command prep helpers
    # --------------------
    void io_uring_sqe_set_data_c 'io_uring_sqe_set_data'(io_uring_sqe_t * sqe, void * data)
    void * io_uring_cqe_get_data_c 'io_uring_cqe_get_data'(const io_uring_cqe_t * cqe)
    void io_uring_sqe_set_data64_c 'io_uring_sqe_set_data64'(io_uring_sqe_t * sqe, __u64 data)
    ...
    int io_uring_cq_eventfd_toggle_c 'io_uring_cq_eventfd_toggle'(io_uring_t *ring, bool enabled)
    int io_uring_wait_cqe_nr_c 'io_uring_wait_cqe_nr'(io_uring_t      *ring,
                                                      io_uring_cqe_t **cqe_ptr,
                                                      unsigned int     wait_nr)
    int io_uring_peek_cqe_c 'io_uring_peek_cqe'(io_uring_t *ring, io_uring_cqe_t **cqe_ptr)
    int io_uring_wait_cqe_c 'io_uring_wait_cqe'(io_uring_t *ring, io_uring_cqe_t **cqe_ptr)
    ...
    void io_uring_buf_ring_add_c 'io_uring_buf_ring_add'(io_uring_buf_ring_t *br,
                                                         ...
                                                         int mask,
                                                         int buf_offset)
    void io_uring_buf_ring_advance_c 'io_uring_buf_ring_advance'(io_uring_buf_ring_t *br, int count)
