...
cdef extern from 'liburing.h' nogil:
    ...
    bool io_uring_opcode_supported_c 'io_uring_opcode_supported'(io_uring_probe_t *p,
                                                                 int op)
...
cpdef bool io_uring_opcode_supported(io_uring_probe p,
                                     int op)
cpdef int io_uring_register_probe(io_uring ring,
                                  io_uring_probe p,
                                  unsigned int nr)
